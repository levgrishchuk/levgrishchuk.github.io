...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Fl(){return new Si({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ro(),fragmentShader:`
		...
		`,blending:Wn,depthTest:!1,depthWrite:!1})}function Ol(){return new Si({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ro(),fragmentShader:`
...
`].filter(vr).join(`
`)),a=Fa(a),a=ql(a,e),a=Yl(a,e),o=Fa(o),o=ql(o,e),o=Yl(o,e),a=jl(a),o=jl(o),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(E=`#version 300 es
